...
def app():
    ...
    for exercise in exercises:
        ...
        edit_btn = cols[2].button("Editar", key=f"edit_{exercise_id}", help="Editar ejercicio")
        del_btn = cols[3].button("Eliminar", key=f"delete_{exercise_id}", help="Eliminar ejercicio")
        ...
        if st.session_state.get("delete_candidate") == exercise_id:
            ...
            if confirm:
                try:
                    ...
                    if deleted:
                        st.success(f"Ejercicio '{exercise_name}' eliminado correctamente.")
                    else:
